...
class potential_field:
    def __init__(self):
        ...
        self.eta = 0.8 # scaling factor for repulsive force
...
#------------------------------------------
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            net_force = self.compute_attractive_force() + self.compute_repulsive_force() ## What should be the net force?
...
#------------------------------------------
    ...
    def compute_repulsive_force(self):
        ...
        for distance in ranges:
            if(distance<self.q_star and distance<0.3):
                mag = self.eta * ((1.0 / self.q_star) - (1.0 / distance)) / (distance** 2)  ## What should be the magnitude of the repulsive force generated by each obstacle point?
            else:
            ...
            vector = np.array([np.cos(angle) * mag, np.sin(angle) * mag])
...
#------------------------------------------
    ...
    def compute_attractive_force(self):
        ...
        if (dist_to_goal<=self.d_star):
            mag = -self.zeta * np.array([pos_x - self.goal.pose.position.x, pos_y -self.goal.pose.position.y]) # Magnitude of attractive force
        else :
