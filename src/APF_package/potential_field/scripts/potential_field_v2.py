...
class potential_field:
    def __init__(self):
        ...
        self.q_star = 0 # threshold distance for obstacles
        self.d_star = 1 # threshoild distance for goal
...
#------------------------------------------
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            net_force = self.compute_attractive_force() ## What should be the net force? call your attractive funtion here 
...
#------------------------------------------
    ...
    def compute_attractive_force(self):
        ...
        if dist_to_goal <= self.d_star:
            mag = -(self.eta * ([pos_x, pos_y] - [self.goal.pose.position.x, self.goal.pose.position.y]))
        
        else:
            mag = -(self.eta * ([pos_x, pos_y] - [self.goal.pose.position.x, self.goal.pose.position.y])) / dist_to_goal
        ## Your stuff
...
#------------------------------------------
    ...
    def handle_global_path(self, path_data):
        if(self.bool_goal == True):
            ...
            self.position_x = []
            self.position_y = []
            print("cscdcsdc", np.shape(self.path_data))
